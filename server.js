...
<body data-theme="dark">
    ...
    if (!container) {
        console.warn('No active tab container found');
        return;
    }
    ...
    // SOLUSI 1: Menggunakan attribute selector tanpa class
    const tabBtn = container.querySelector(`[data-tab="${tabId}"]`);
    
    // SOLUSI 2: Atau menggunakan concat string (lebih aman)
    // const tabBtn = container.querySelector('[data-tab="' + tabId + '"]');
    
    // SOLUSI 3: Atau cari semua dan filter
    // const tabBtn = Array.from(container.querySelectorAll('.tab-btn'))
    //     .find(btn => btn.getAttribute('data-tab') === tabId);
    ...
    if (tabBtn) {
        ...
        // Debug: Tampilkan semua tab buttons yang ada
        const allTabBtns = container.querySelectorAll('.tab-btn');
